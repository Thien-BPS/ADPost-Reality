...
export const singularityMilestones = {
  ...
  continuumMult: {
    ...
    effect: completions => completions * (devVars.celestials.laitela.improveUnlimitedMilestones ? 0.075 : 0.03),
  ...
  darkMatterMult: {
    ...
    effect: completions => Math.pow((devVars.celestials.laitela.improveUnlimitedMilestones ? 3.2 : 1.5), completions),
  ...
  darkEnergyMult: {
    ...
    effect: completions => Math.pow((devVars.celestials.laitela.improveUnlimitedMilestones ? 5 : 2), completions),
  ...
  darkDimensionCostReduction: {
    ...
    effect: completions => Math.pow((devVars.celestials.laitela.improveUnlimitedMilestones ? 0.12 : 0.4), completions),
  ...
  singularityMult: {
    ...
    effect: completions => Math.pow((devVars.celestials.laitela.improveUnlimitedMilestones ? 6 : 2), completions),
  ...
  darkDimensionIntervalReduction: {
    ...
    effect: completions => Math.pow((devVars.celestials.laitela.improveUnlimitedMilestones ? 0.28 : 0.6), completions),
    effectFormat: x => `/ ${format(1 / x, 2, 2)}`,
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  improvedAscensionDM: {
    ...
    effect: completions => devVars.celestials.laitela.improveUnlimitedMilestones ? Math.pow(completions, 3) : 100 * completions,
  ...
  ascensionIntervalScaling: {
    ...
    effect: completions => 1200 - (devVars.celestials.laitela.improveLimitedMilestones ? 150 : 50) * completions,
  ...
  realityDEMultiplier: {
    ...
    effect: completions => Math.pow(
      devVars.celestials.laitela.improveLimitedMilestones ? completions : 1 + 0.05 * completions,
      Laitela.difficultyTier),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  ...
  darkFromTesseracts: {
    ...
    effect: () => Math.pow((devVars.celestials.laitela.improveExternalMilestones ? 4 : 1.1), Tesseracts.effectiveCount),
    effectFormat: x => formatX(x, 2, 2),
  ...
  darkFromTheorems: {
    ...
    effect: () => {
      if (devVars.celestials.laitela.improveExternalMilestones) return Math.cbrt(Math.clampMin(Currency.timeTheorems.value.log10()));
      return Math.sqrt(Math.clampMin((Currency.timeTheorems.value.log10() - 1000) / 50, 1));
    },
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  ...
  theoremPowerFromSingularities: {
    ...
    effect: () => 1 + Math.log10(Currency.singularities.value + 1) / (devVars.celestials.laitela.improveExternalMilestones ? 47 : 70),
  ...
  darkFromDilatedTime: {
    ...
    effect: () => Math.pow((devVars.celestials.laitela.improveExternalMilestones ? 2 : 1.6), Decimal.log10(Currency.dilatedTime.value.plus(1)) / 1000),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  infinitiedPow: {
  ...
  tesseractMultFromSingularities: {
    ...
    effect: () => 1 + Math.log10(Currency.singularities.value) / (devVars.celestials.laitela.improveExternalMilestones ? 37 : 80),
    effectFormat: x => formatX(Math.clampMin(x, 1), 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_MAIN,
  }
};
